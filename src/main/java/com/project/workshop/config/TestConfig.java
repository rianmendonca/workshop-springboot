...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2023-10-26T12:50:18Z"), u1);
        Order o2 = new Order(null, Instant.parse("2023-08-13T08:20:08Z"), u2);
        Order o3 = new Order(null, Instant.parse("2023-05-11T06:03:01Z"), u1);
